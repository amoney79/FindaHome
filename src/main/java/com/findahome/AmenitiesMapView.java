...
public class AmenitiesMapView extends StackPane {
    ...
    public AmenitiesMapView() {
        ...
        carousel.getChildren().addAll(
                createHighlightCard("The Nairobi Hospital", "4.8", "0.5 km \u2022 Open 24 Hours", "HOSPITAL", "#ef4444",
                        "View Medical Services"),
                createHighlightCard("Nairobi Arboretum", "4.6", "1.2 km \u2022 Closes 6 PM", "PARK", "#22c55e",
                        "Get Directions"),
                createHighlightCard("Kileleshwa Academy", "4.9", "0.3 km \u2022 International", "SCHOOL", PRIMARY,
                        "Inquire Enrollment"));
