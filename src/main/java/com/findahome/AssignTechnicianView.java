...
public class AssignTechnicianView extends StackPane {
    ...
    public AssignTechnicianView(String requestTitle, String requestDesc, String imgUrl) {
        ...
        scrollContent.setPadding(new Insets(20, 0, 150, 0));
        ...
        // Request Summary
        VBox summarySect = new InsetsBox(new Insets(0, 20, 0, 20));
        HBox summaryCard = new HBox(15);
        summaryCard.setPadding(new Insets(15));
        summaryCard.setStyle("-fx-background-color: " + CARD_BG + "; -fx-background-radius: 16; -fx-border-color: "
                + BORDER_COLOR + ";");
        ...
        confirmBtn.setOnAction(e -> MainApp.navigateTo(new SuccessView("Assignment Confirmed",
    ...
    private VBox createProviderCard(String name, String rating, String meta, String url, boolean selected) {
        ...
        card.setStyle(selected
                ? "-fx-background-color: " + CARD_BG + "; -fx-background-radius: 16; -fx-border-color: " + PRIMARY
                        + "; -fx-border-width: 2;"
                : "-fx-background-color: " + CARD_BG + "; -fx-background-radius: 16; -fx-border-color: " + BORDER_COLOR
                        + "; -fx-opacity: 0.8;");
        ...
        ImageView iv = new ImageView();
        try {
            iv.setImage(new Image(url, 56, 56, true, true));
        } catch (Exception e) {
        }
        iv.setFitWidth(56);
        iv.setFitHeight(56);
    ...
    private static class InsetsBox extends VBox {
        public InsetsBox(Insets insets) {
            setPadding(insets);
        }
    }
}
