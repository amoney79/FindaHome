...
public class EarningsAnalyticsView extends StackPane {
    ...
    public EarningsAnalyticsView() {
        ...
        chartCard.setStyle("-fx-background-color: " + CARD_BG + "; -fx-background-radius: 20; -fx-border-color: "
                + BORDER_COLOR + ";");
        ...
        transList.getChildren().addAll(
                createTransactionRow("John Doe", "Skyline Apts - 4B", "+KSh 45,000", "Oct 12, 2024", "JD", PRIMARY),
                createTransactionRow("Sarah Mwangi", "Palm Heights - 12", "+KSh 32,500", "Oct 11, 2024", "SM",
                        "#3b82f6"),
                createTransactionRow("Peter Kamau", "Sunset Villas - C3", "KSh 55,000", "Pending", "PK", "#f97316"));
        ...
        bottomNav.setStyle(
                "-fx-background-color: #111813; -fx-border-color: " + BORDER_COLOR + "; -fx-border-width: 1 0 0 0;");
        bottomNav.getChildren().addAll(
                ...
                createAdminNavItem("Profile", "\ud83d\udc64", false, e -> MainApp.navigateTo(new TenantProfileView())));
