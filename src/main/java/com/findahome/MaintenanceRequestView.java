...
public class MaintenanceRequestView extends BorderPane {
        ...
        public MaintenanceRequestView() {
                ...
                backBtn.setOnMouseClicked(
                                e -> MainApp.navigateCached("maintenance_list", MaintenanceRequestsListView::new));
                ...
                lowBtn = createPriorityButton("Low");
                medBtn = createPriorityButton("Medium");
                highBtn = createPriorityButton("High");
                ...
                addPhoto.setStyle("-fx-background-color: transparent; -fx-border-color: " + BORDER_COLOR
                                + "; -fx-border-style: dashed; -fx-border-width: 2; -fx-border-radius: 12; -fx-cursor: hand;");
                ...
                submitBtn.setOnAction(e -> MainApp.navigateCached("success_maintenance", () -> new SuccessView(
                                "Request Submitted!",
                                "Our maintenance team has received your ticket and will respond within 24-48 hours.",
                                "Continue",
                                () -> MainApp.navigateCached("maintenance_list", MaintenanceRequestsListView::new))));
        ...
        private void updatePriorityStyles() {
                ...
                lowBtn.setStyle(selectedPriority.equals("Low") ? activeStyle : baseStyle);
                medBtn.setStyle(selectedPriority.equals("Medium") ? activeStyle : baseStyle);
                highBtn.setStyle(selectedPriority.equals("High") ? activeStyle : baseStyle);
        }
        ...
        private StackPane createImageThumbnail(String url) {
                ...
                xBtn.setStyle(
                                "-fx-background-color: #ef4444; -fx-text-fill: white; -fx-background-radius: 12; -fx-padding: 2; -fx-font-size: 10; -fx-cursor: hand;");
