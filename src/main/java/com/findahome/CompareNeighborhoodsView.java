...
public class CompareNeighborhoodsView extends VBox {
        ...
        public CompareNeighborhoodsView() {
                ...
                header.setStyle("-fx-border-color: " + DIVIDER_COLOR
                ...
                safetyCard.getChildren().add(createProgressRow("Kilimani", "7.9/10", 0.79, "#64748b")); // Slate-500
                                                                                                        // logic
                ...
                infraList.getChildren().add(
                                createComparisonRow("Distance to CBD", "5.2 km", "~15 min drive", "4.8 km",
                                                "~12 min drive", true)); // Left
                                                                         // highlighted?
                                                                         // HTML
                                                                         // shows
                                                                         // left
                                                                         ...
                                                                         // visual.
                infraList.getChildren().add(
                                createComparisonRow("Public Transport Access", "\u2605 Moderate", "",
                                                "\u2726 Excellent", "", true)); // Custom
                                                                                // content
                                                                                // logic
                                                                                // needed
                                                                                // for
        ...
        private VBox createComparisonRow(String title, String val1, String sub1, String val2, String sub2,
                ...
                v1.setTextFill(!highlightRight && val1.contains("km") ? Color.web(PRIMARY) : Color.WHITE); // Logic
                                                                                                           // specific
                                                                                                           // to
                                                                                                           // visual
