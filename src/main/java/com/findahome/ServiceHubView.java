...
public class ServiceHubView extends StackPane {
        ...
        public ServiceHubView() {
                ...
                movingGrid.add(createServiceCard("Moving Checklist", "\u2713", "#f46a25",
                                e -> MainApp.navigateCachedFullScreen("checklist", MovingChecklistView::new)), 0, 0);
                movingGrid.add(createServiceCard("Movers Quotes", "\ud83d\ude9a", "#3b82f6",
                                e -> MainApp.navigateCachedFullScreen("quotes", MoversQuoteRequestView::new)), 1, 0);
                movingGrid.add(createServiceCard("Neighborhood Guide", "\ud83d\uddfa", "#8b5cf6",
                                e -> MainApp.navigateCachedFullScreen("guide", GuideView::new)), 0, 1);
                movingGrid.add(createServiceCard("Market Trends", "\ud83d\udcc8", "#ec4899",
                                e -> MainApp.navigateCachedFullScreen("market", MarketTrendsView::new)), 1, 1);
                ...
                homeGrid.add(createServiceCard("Maintenance", "\ud83d\udee0", PRIMARY,
                                e -> MainApp.navigateCached("maintenance_list", MaintenanceRequestsListView::new)), 0,
                                0);
                homeGrid.add(createServiceCard("Lease Agreements", "\ud83d\udcc4", "#eab308",
                                e -> MainApp.navigateCachedFullScreen("lease", LeaseAgreementView::new)), 1, 0);
                homeGrid.add(createServiceCard("Neighborhood Alerts", "\ud83d\udd14", "#f43f5e",
                                e -> MainApp.navigateCachedFullScreen("alerts", NeighborhoodAlertsView::new)), 0, 1);
                homeGrid.add(createServiceCard("Payment History", "\ud83d\udcb3", "#10b981",
                                e -> MainApp.navigateCachedFullScreen("payments", PaymentHistoryView::new)), 1, 1);
                ...
                discoveryList.getChildren().addAll(
                                createWideServiceCard("Commute Calculator", "\ud83d\ude97",
                                                "Calculate travel time to work/school",
                                                e -> MainApp.navigateCachedFullScreen("commute",
                                                                CommuteCalculatorView::new)),
                                createWideServiceCard("County Discovery", "\ud83c\udfde",
                                                "Explore different counties in Kenya",
                                                e -> MainApp.navigateCachedFullScreen("county",
                                                                CountyDiscoveryView::new)));
