...
public class PropertyDetailView extends StackPane {
    ...
    public PropertyDetailView(Property property) {
        ...
        Region dot1 = new Region(); dot1.setPrefSize(24, 6); dot1.setStyle("-fx-background-color: " + PRIMARY + "; -fx-background-radius: 3;");
        Region dot2 = new Region(); dot2.setPrefSize(6, 6); dot2.setStyle("-fx-background-color: rgba(255,255,255,0.5); -fx-background-radius: 3;");
        Region dot3 = new Region(); dot3.setPrefSize(6, 6); dot3.setStyle("-fx-background-color: rgba(255,255,255,0.5); -fx-background-radius: 3;");
        ...
        detailsContent.setStyle("-fx-background-color: " + BACKGROUND_DARK + "; -fx-background-radius: 24 24 0 0;");
        ...
        Label vIcon = new Label("\u2705"); vIcon.setStyle("-fx-font-size: 10;");
        ...
        Label descText = new Label("Experience high-end urban living in this sun-drenched sanctuary. Featuring floor-to-ceiling windows, premium smart home integration, and breathtaking city views... ");
        descText.setTextFill(Color.web("#d4d4d8"));
        descText.setFont(Font.font(14));
        Hyperlink readMore = new Hyperlink("Read more");
        readMore.setStyle("-fx-text-fill: " + PRIMARY + "; -fx-font-weight: bold; -fx-padding: 0; -fx-underline: false;");
        ...
        mapClip.setArcWidth(32); mapClip.setArcHeight(32);
        ...
        try {
            Image mImg = new Image("https://lh3.googleusercontent.com/aida-public/AB6AXuDmJKi3AjCR1tsFqjXnk8X10w99rFPOyb_vJCEmNpq90mdmykPyJFYThswbvyF1zam4SkcuiMAE67JO8RwF7HkYV5Wmst3h1nx0UYBR3l1Nn8Fote_CNUyiJ1uRGSx37gXe_CNLMio3HC1h9cXJFZP1aQ7FyD5pvXr2iH8Nny_DuiSEgmEXpJnKT6YgfowuMOdBNyNN-_yI89HnYS1Els2s5AUpLi1lPY_KxYp9bFEJqRfVyl5k-3W3wouiPcGVrAhAJ4WgPr_XMrw", 400, 160, false, true);
        ...
        Label lIcon = new Label("\ud83d\udccd"); lIcon.setTextFill(Color.web(PRIMARY));
        Label lText = new Label(property.getLocation()); lText.setTextFill(Color.WHITE); lText.setFont(Font.font(12));
        ...
        try {
            avatar.setImage(new Image("https://lh3.googleusercontent.com/aida-public/AB6AXuADYVf8eJncumdqgsYLbFLdbO5JZWBSUaW6QfAzQj_wCxAKckepu4JQsmELaxJs1c3xJSvwrtqDYG6h7Rvc0b7V9eZLOcDBrvt-QP61mEq4NKlEKPI0MzRsUpU5gnbicTnnjMtbLHkT0ivL0czKWbCHzepGr-D5cpqtx6wgEih7-1g2PVtq123pu2oIstuKRHLOLtwzxIAb59x6p5scEi-Y-wZ2X_EZfRjm3C4piglsRhbnbrX42ozb61TFblD2ndYxjnLQ65Hxhts", 48, 48, true, true));
        } catch (Exception e) {}
        avatar.setClip(avatarClip);
        avatarBox.getChildren().add(avatar);
        
        VBox agentMeta = new VBox(2);
        Label agentName = new Label("Kelvin Mwangi"); agentName.setTextFill(Color.WHITE); agentName.setFont(Font.font("System", FontWeight.BOLD, 14));
        HBox ratingBox = new HBox(4);
        ratingBox.setAlignment(Pos.CENTER_LEFT);
        Label star = new Label("\u2b50"); star.setStyle("-fx-font-size: 10;");
        Label ratingText = new Label("4.9 (124 reviews)"); ratingText.setTextFill(Color.web(TEXT_GRAY)); ratingText.setFont(Font.font(12));
        ...
        detailsContent.getChildren().addAll(header, priceBox, descFlow, amenitiesSection, locationSection, agentCard);
        ...
        Label totalLbl = new Label("TOTAL"); totalLbl.setTextFill(Color.web(TEXT_GRAY)); totalLbl.setFont(Font.font("System", FontWeight.BOLD, 10));
        Label finalPriceLbl = new Label(property.getPrice()); finalPriceLbl.setTextFill(Color.WHITE); finalPriceLbl.setFont(Font.font("System", FontWeight.BOLD, 20));
        ...
        bookBtn.setStyle("-fx-background-color: " + PRIMARY + "; -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 16; -fx-background-radius: 12;");
    ...
    private Button createCircleBtn(String icon) {
        Button btn = new Button(icon);
        btn.setStyle("-fx-background-color: white; -fx-text-fill: " + PRIMARY + "; -fx-font-size: 16; -fx-min-width: 40; -fx-min-height: 40; -fx-background-radius: 20; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.1), 5, 0, 0, 2);");
        btn.setCursor(javafx.scene.Cursor.HAND);
        return btn;
    }
}
