...
public class DepositPaymentView extends StackPane {
    ...
    public DepositPaymentView() {
        ...
        propertyCard.setStyle("-fx-background-color: " + CARD_BG + "; -fx-background-radius: 16; -fx-border-color: "
                + BORDER_COLOR + ";");
        ...
        breakCard.setStyle("-fx-background-color: rgba(255,255,255,0.03); -fx-background-radius: 16; -fx-border-color: "
                + BORDER_COLOR + ";");
        ...
        payBtn.setOnAction(e -> MainApp.navigateTo(new SuccessView("Payment Successful!",
    ...
    private HBox createPaymentOption(String title, String desc, String iconText, boolean selected) {
        ...
        container.setStyle("-fx-background-color: " + (selected ? "rgba(19, 127, 236, 0.05)" : "transparent")
                + "; -fx-background-radius: 12; -fx-border-color: " + (selected ? PRIMARY : BORDER_COLOR)
                + "; -fx-border-width: 2;");
