...
public class LinkPayoutMethodView extends BorderPane {
        ...
        public LinkPayoutMethodView() {
                ...
                backBtn.setOnMouseClicked(e -> MainApp.navigateCached("landlord_revenue", EarningsAnalyticsView::new));
                ...
                try {
                        bgImg.setImage(new Image(
                                        ...
                                        480, 240, false, true, true));
                } catch (Exception e) {
                }
                bgImg.setFitWidth(400); // constrained to width
                bgImg.setFitHeight(240);
                bgImg.setPreserveRatio(false);

                Region overlay = new Region();
                overlay.setStyle(
                                "-fx-background-color: linear-gradient(rgba(16, 34, 22, 0.7), rgba(16, 34, 22, 0.7));");
                ...
                panel.setStyle("-fx-background-color: " + CARD_BG
                                + "; -fx-background-radius: 12; -fx-border-color: #3b5443;");
                ...
                Label panelDesc = new Label(
                                "Your data is protected with 256-bit encryption and full PCI-DSS compliance.");
                ...
                addBtn.setStyle("-fx-background-color: " + PRIMARY + "; -fx-text-fill: " + BACKGROUND_DARK
                                + "; -fx-font-weight: bold; -fx-font-size: 18; -fx-background-radius: 12; -fx-cursor: hand; -fx-effect: dropshadow(three-pass-box, rgba(19, 236, 91, 0.2), 10, 0, 0, 5);");
                addBtn.setOnAction(e -> MainApp.navigateCached("bank_details_entry", BankDetailsEntryView::new));
