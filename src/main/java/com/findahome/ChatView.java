...
public class ChatView extends StackPane {
        ...
        public ChatView() {
                ...
                inputFrame.setStyle(
                                "-fx-background-color: #1a2e20; -fx-background-radius: 12; -fx-border-color: " + PRIMARY
                                                + "1a;");
        ...
        private HBox createAgentMessage(String text) {
                ...
                msg.setMaxWidth(280);
                msg.setStyle(
                                "-fx-background-color: " + BUBBLE_AGENT
                                                + "; -fx-background-radius: 16 16 16 2; -fx-padding: 12 16;");
        ...
        private HBox createUserMessage(String text) {
                ...
                msg.setWrapText(true);
                msg.setMaxWidth(280);
                msg.setStyle("-fx-background-color: " + PRIMARY
                                + "; -fx-background-radius: 16 16 2 16; -fx-padding: 12 16;");
