...
public class PropertyData {
        private static PropertyRepository repo = new PropertyRepository();

        public static void seedResults() {
                if (repo.getAllProperties().isEmpty()) {
                        repo.addProperty(new Property("Skyline Luxury Penthouse", "Kilimani, Nairobi", "KSh 250,000",
                                        250000,
                        ...
                        repo.addProperty(new Property("Garden Oasis Villa", "Karen, Nairobi", "KSh 180,000", 180000,
                                        "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=400&q=80",
                                        true,
                                        "EXCLUSIVE",
                                        "4 Beds", "4 Baths", "4,000 sqft", "Villa"));

                        repo.addProperty(new Property("Modern Urban Studio", "Westlands, Nairobi", "KSh 85,000", 85000,
                                        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=400&q=80",
                                        true,
                                        "EXCLUSIVE",
                                        "1 Bed", "1 Bath", "600 sqft", "Studio"));

                        repo.addProperty(new Property("Cozy Family Home", "Runda, Nairobi", "KSh 120,000", 120000,
                        ...
                        repo.addProperty(new Property("Luxury Apartment", "Kileleshwa, Nairobi", "KSh 45,000", 45000,
                        ...
                        repo.addProperty(new Property("Executive Mansionette", "Nairobi CBD", "KSh 320,000", 320000,
