...
public class ApplicationTrackerView extends StackPane {
    ...
    public ApplicationTrackerView() {
        ...
        entryList.getChildren().addAll(
                createApplicationEntry("Modern 2BR Apartment", "Nairobi West \u2022 $1,200/mo", "SUBMITTED", 1,
        ...
        bottomPanel.setStyle("-fx-background-color: " + CARD_DARK + "; -fx-background-radius: 20; -fx-border-color: "
                + BORDER_COLOR + ";");
    ...
    private HBox createApplicationEntry(String title, String meta, String status, int step, String imgUrl,
        ...
        String badgeColor = status.contains("REVIEW") ? "#f59e0b" : status.contains("CHECK") ? "#a855f7" : PRIMARY;
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            s.setStyle("-fx-background-radius: 2; -fx-background-color: " + (i <= step ? PRIMARY : "#3b4754") + ";");
