...
public class ManageAlertsView extends StackPane {
    ...
    public ManageAlertsView() {
        ...
        backBtn.setStyle("-fx-background-color: rgba(255,255,255,0.05); -fx-background-radius: 20; -fx-cursor: hand;");
        ...
        alertList.getChildren().addAll(
                createAlertCard("Nairobi > Westlands > Kileleshwa", "< 50k KES | 1-bed apartment", "Last match: 2h ago",
                        true),
                createAlertCard("Mombasa > Nyali", "< 100k KES | 3-bed house", "Last match: Yesterday", true),
    ...
    private VBox createAlertCard(String location, String criteria, String status, boolean active) {
        ...
        iconBox.setStyle("-fx-background-color: " + (active ? "rgba(19, 236, 91, 0.1)" : "rgba(157, 166, 185, 0.1)")
