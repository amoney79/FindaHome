...
public class InviteRewardView extends StackPane {
        ...
        public InviteRewardView() {
                ...
                Label subline = new Label(
                                "Help your friends find their dream home and get rewarded when they move in.");
                ...
                codeBox.setStyle("-fx-background-color: " + BACKGROUND_DARK
                ...
                stepList.getChildren().addAll(
                                createStep(1, "Invite Friends",
                                                "Share your unique referral link or code with your network.", true),
                                createStep(2, "They Sign a Lease",
                                                "Your friend finds a home and completes their lease through FindaHome.",
                                                false),
                                createStep(3, "You Both Get Rewarded",
                                                "You each receive a $50 bonus directly to your digital wallet.",
                                                false));
                ...
                historyLink.setOnMouseClicked(e -> MainApp.navigateTo(new ReferralHistoryView()));
