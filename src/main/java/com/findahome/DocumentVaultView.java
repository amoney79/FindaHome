...
public class DocumentVaultView extends StackPane {
    ...
    public DocumentVaultView() {
        ...
        storageCard.setStyle("-fx-background-color: " + CARD_BG + "; -fx-background-radius: 16; -fx-border-color: "
                + BORDER_COLOR + ";");
        ...
        fileList.getChildren().addAll(
                createFileRow("Apartment_Lease_2023.pdf", "Oct 12, 2023 \u2022 2.4 MB", "\ud83d\udcc4", "#ef4444"),
                createFileRow("Rent_Receipt_Nov.png", "Nov 01, 2023 \u2022 850 KB", "\ud83d\uddbc", "#3b82f6"),
                createFileRow("National_ID_Scan.jpg", "Sep 24, 2023 \u2022 1.2 MB", "\ud83d\udee1", "#22c55e"),
                createFileRow("Kitchen_Repair_Log.docx", "Aug 15, 2023 \u2022 45 KB", "\ud83d\udcc4", "#94a3b8"));
