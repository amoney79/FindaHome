...
public class HelpSupportView extends StackPane {
    ...
    public HelpSupportView() {
        ...
        HBox.setMargin(title, new Insets(0, 48, 0, 0)); // Offset for back button to center title
        ...
        contactList.getChildren().addAll(
                createContactBtn("\ud83d\udcac", "Live Chat", "Instant response (Typical: 2 mins)", PRIMARY, true),
                createContactBtn("\u2709\ufe0f", "Email Support", "Reply within 24 hours", "#28392e", false),
        ...
        bottomNav.setStyle("-fx-background-color: rgba(16, 34, 22, 0.9); -fx-border-color: " + BORDER_COLOR
        ...
        bottomNav.getChildren().addAll(
                ...
                createNavItem("Support", "\ud83c\udfa7", true, e -> {
                }),
                createNavItem("Profile", "\ud83d\udc64", false, e -> MainApp.navigateTo(new TenantProfileView())));
