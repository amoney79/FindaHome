...
public class OnboardingTwoView extends StackPane {
        ...
        public OnboardingTwoView() {
                ...
                checkCircle.setStyle("-fx-background-color: " + PRIMARY
                                + "; -fx-background-radius: 40; -fx-border-color: "
                                + BACKGROUND_DARK
                ...
                nextBtn.setOnAction(e -> MainApp.navigateToFullScreen(new OnboardingThreeView()));
