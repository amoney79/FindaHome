...
public class LeaseSigningCompleteView extends StackPane {
        ...
        public LeaseSigningCompleteView() {
                ...
                Label subTitle = new Label(
                                "Congratulations! Your agreement for Sunrise Apartments is now legally binding.");
                ...
                paymentStep.setOnMouseClicked(
                                e -> MainApp.navigateCachedFullScreen("payment", DepositPaymentView::new));

                timeline.getChildren().addAll(
                                paymentStep,
                                createTimelineStep("\ud83d\udcc5", "Schedule Move-in",
                                                "Available after payment confirmation.", true),
                                createTimelineStep("\ud83d\udd11", "Collect Keys", "At the property on move-in day.",
                                                false));
                ...
                msgBtn.setStyle("-fx-background-color: " + CARD_BG
                                + "; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 12; -fx-border-color: "
                                + BORDER_COLOR + ";");
                msgBtn.setOnAction(e -> MainApp.navigateCached("messages", ChatView::new));
