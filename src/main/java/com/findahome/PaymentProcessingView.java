...
public class PaymentProcessingView extends StackPane {
        ...
        public PaymentProcessingView() {
                ...
                Label instruction = new Label(
                                "Please check your phone for the M-Pesa PIN prompt to authorize this deposit.");
                ...
                cancelBtn.setStyle("-fx-background-color: transparent; -fx-text-fill: " + TEXT_GRAY
                                + "; -fx-font-weight: bold; -fx-background-radius: 0 0 0 20; -fx-border-color: "
                                + BORDER_COLOR
                ...
                modal.getChildren().addAll(handle, logoContainer, title, detailsBox, spinnerStack, instruction,
                                subInstruction,
                ...
                Timeline simulation = new Timeline(new KeyFrame(Duration.millis(500), e -> {
                        MainApp.navigateTo(new SuccessView("Payment Successful!",
                                        "Your deposit has been received. You can now schedule your move-in date.",
