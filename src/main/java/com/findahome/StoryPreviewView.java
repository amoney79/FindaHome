...
public class StoryPreviewView extends StackPane {
        ...
        public StoryPreviewView(Property property) {
                ...
                shareBtn.setOnAction(e -> MainApp.navigateTo(new SuccessView("Shared to Stories",
                                "Your property story has been shared successfully.")));
                ...
                saveBtn.setOnAction(e -> MainApp.navigateTo(new SuccessView("Saved to Device",
                                "The story preview has been saved to your gallery.")));
