...
public class BankDetailsEntryView extends StackPane {
    ...
    public BankDetailsEntryView() {
        ...
        footer.setStyle("-fx-background-color: linear-gradient(to top, " + BACKGROUND_DARK + " 80%, transparent);");
    ...
    private VBox createBankDropdown() {
        ...
        cb.getItems().addAll("Kenya Commercial Bank (KCB)", "Equity Bank", "ABSA Bank Kenya", "Co-operative Bank",
                "Stanbic Bank");
