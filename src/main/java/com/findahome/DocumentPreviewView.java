...
public class DocumentPreviewView extends BorderPane {
        ...
        public DocumentPreviewView(String documentTitle) {
                ...
                backBtn.setOnMouseClicked(e -> MainApp.navigateCached("vault", DocumentVaultView::new));
                ...
                docContainer.setStyle("-fx-background-color: #1a1f2e; -fx-background-radius: 12; -fx-border-color: "
                                + BORDER_COLOR
                ...
                detailsSec.setPadding(new Insets(10, 20, 40, 20));
                ...
                sendBtn.setOnAction(e -> MainApp.navigateCached("success", () -> new SuccessView("Document Sent!",
